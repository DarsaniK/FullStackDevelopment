  ...
  return (
    <nav className="navbar">
      ...
      <div className="navbar-right">
        <button className="btnh" onClick={handleAhome}>Home</button>
        <button className="btnh" onClick={handleHome}>Student Profile</button>
        <button className="btnh" onClick={handleStudent}>Fees payment</button>
        <button className="btnh" onClick={handleCourse}>Add courses</button>
        <button className="btnh" onClick={handleInstitute}>Add Institute</button>
