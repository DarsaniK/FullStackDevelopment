...
import srmImage from '../../assets/images/srm.jpg'
import psgImage from '../../assets/images/PSG.jpg'
import birlaImage from '../../assets/images/birla.jpg'
import vitImage from '../../assets/images/vit.jpeg'
import skctImage from '../../assets/images/skct.jpeg'
import amritaImage from '../../assets/images/image1.jpg'
import logo1Image from '../../assets/images/1-removebg-preview .png'
import missionImage from '../../assets/images/mission.gif';
import visionImage from '../../assets/images/vision.gif';
  ...
  return (
    <div className="home-container">
      ...
      <div className="content">
        ...
        <h1>
          <br></br>
          <span style={{ color: 'blue' }}>MSD  </span>Online Admissions<br></br><br></br>A <span style={{ color: 'blue' }}>GREETY </span> WELCOME !!!
        </h1>
        <div className='text'>
          <h1>LEARN FROM INDIA'S TOP <span style={{ color: 'blue' }}> RANKED </span>INSTITUTE</h1>
        </div>
      </div>
      ...
      <div className="course-section">
        <h1>Courses that are Offered in 2022</h1>
        <table>
          <thead>
            <tr>
      ...
      <div className="aboutus-section">
        ...
        <div className="aboutus-container">
          <div className="mission">
            ...
            <p><h2><span style={{ color: 'blue' }}>Mission</span></h2>
          ...
          <img src={visionImage} alt="Vision" />
            <p>
            <h2><span style={{ color: 'blue' }}>Vision</span></h2>
